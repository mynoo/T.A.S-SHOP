...
public class PagingR {
	...
	public PagingR(String _pageNumber, int totalCount, String url,
			String mode, String keyword, int pno) {
		...
		// 필드 검색을 위한 변수
		String field_search = "&mode=" + this.mode + "&keyword=" + this.keyword + "&pno=" + this.pno ;
