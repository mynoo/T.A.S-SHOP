				...
				<div class="signup-form">
					<form method="post" class="register-form" id="register-form"
						...
						<button type="button" class="btn btn-danger"
							...
							onclick="location.href='<%=Noform%>prList'">
							<b>X</b>
						</button>
						<div class="form-row">
							<div class="form-group">
								<div class="form-input">
									<label for="pname" class="required">Pname</label> <input
								...
								<div class="form-input">
									<label for="image" class="required">Image</label> <input
										type="file" name="image" id="image" value="${bean.image}" /> <span
							...
							<div class="form-group">
								...
								<div class="form-input">
									<label for="name" class="required">Date</label> <input
										type="date" name="date" id="date" value="${bean.date}" /> <span
										class="err form-control-static">${errdate}</span>
								</div>
								<div class="form-input">
									<label for="alcohol" class="required">Alcohol</label> <input
										type="number" name="alcohol" id="alcohol"
										value="${bean.alcohol}" /> <span
										class="err form-control-static">${erralcohol}</span>
								</div>
								<div class="form-input">
								...
								<div class="form-input">
									<label for="content" class="required">Content</label> <input
										...
										value="${bean.content}" /> <span
										class="err form-control-static">${errcontent}</span>
								</div>
								...
								<div class="form-input">
									...
									</select> <span class="err form-control-static">${errcategory}</span>
								</div>
